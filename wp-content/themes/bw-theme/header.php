        ...
        <div class="menu">
            ...
            <nav class="menu__body">
                <ul class="menu__list">
                    ...
                    <li><a id="#lot" href="#lot" class="menu__link _goto-block">Ассортимент</a></li>
                    <li><a href="#test" class="menu__link _goto-block">Наши услуги</a></li>
                    <li><a href="#contact" class="menu__link _goto-block">Контакты</a></li>
                </ul>
            </nav>
        </div>
